...
class TestCardData(unittest.TestCase):
    ...
    def test_name_to_data_name(self):
        ...
        # Act
        test_card_data_name_1 = Card.Card.to_context_name(test_card_name_1)
        test_card_data_name_2 = Card.Card.to_context_name(test_card_name_2)
