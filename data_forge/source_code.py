...
class SourceCode:
    ...
    def update_card(card_type : str, card_name : str, card_url_ending : str) -> str:
        ...
        card_source_code_path = FileHandler.get_card_source_code_directory(card_type, card_data_name)
        ...
        card_pretty_code_path = FileHandler.get_card_pretty_code_directory(card_type, card_data_name)
