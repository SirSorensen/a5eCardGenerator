...
class MagicItem(CardData):
    def __init__(self, name : str, url_ending : str = "", should_scrape_source_text : bool = False):
        ...
        super(MagicItem, self).__init__(name, url_ending=url_ending, should_scrape_source_text=should_scrape_source_text)
    ...
    def extract_spell(self):
        ...
        return super(MagicItem, self).extract_fields(field_classes, field_ids)
